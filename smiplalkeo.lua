...
Исправлен текст проведения собеседования.



Версия 3.9.5:

Исправлены номера волн в эфирах. 
...
function main()
	...
	while true do wait(0)
		...
		if sampIsLocalPlayerSpawned() and spawn then
			...
			sampAddChatMessage("[ИНФОРМАЦИЯ] {FFFFFF}Последее обновление: "..curcolor.."{FFFACD} 13.07.2024", curcolor1)
