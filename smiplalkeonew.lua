...
changelogtext = u8[[
Версия 3.9.5: (только для сми лс, сервера Yuma).
...
function main()
	...
	while true do wait(0)
		...
		if sampIsLocalPlayerSpawned() and spawn then
			...
			sampAddChatMessage("[ИНФОРМАЦИЯ] {FFFFFF}Последее обновление: "..curcolor.."{008000} 09.07.2024 {0000ff}в 17:50 МСК.", curcolor1)
